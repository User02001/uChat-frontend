...
html[data-theme="light"] body [data-signup-page="true"] {
 color: #111 !important;
}

html[data-theme="light"] body [data-signup-page="true"] *,
html[data-theme="light"] body [data-signup-page="true"] *::before,
html[data-theme="light"] body [data-signup-page="true"] *::after {
 color: inherit !important;
}

html[data-theme="light"] body [data-signup-page="true"] input,
html[data-theme="light"] body [data-signup-page="true"] select,
html[data-theme="light"] body [data-signup-page="true"] textarea,
html[data-theme="light"] body [data-signup-page="true"] option {
 color: inherit !important;
 -webkit-text-fill-color: inherit !important;
}

html[data-theme="light"] body [data-signup-page="true"] input::placeholder,
html[data-theme="light"] body [data-signup-page="true"] textarea::placeholder {
 color: #555 !important;
 opacity: 1 !important;
}

html[data-theme="light"] body [data-signup-page="true"] a,
html[data-theme="light"] body [data-signup-page="true"] a:visited {
 color: inherit !important;
}
`;
...
if (typeof document !== 'undefined') {
 ...
 let styleTag = document.getElementById('signup-stylex-injected');
 if (!styleTag) {
 ...
 if (!window.__signupStylexHeadObserver) {
  const ensureLast = () => {
   const tag = document.getElementById('signup-stylex-injected');
  ...
  window.__signupStylexHeadObserver = observer;
 }
}
